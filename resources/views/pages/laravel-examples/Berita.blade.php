<x-layout bodyClass="g-sidenav-show  bg-gray-200">
    ...
    <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
        <!-- Navbar -->
        <x-navbars.navs.auth titlePage="Berita"></x-navbars.navs.auth>
        <!-- End Navbar -->
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="me-3 my-3 text-start">
                        <a class="btn bg-0057FF mb-0 " href="addberita" style="background-color: #0057FF;">
                            <i class="text-sm text-white" >Tambah</i>
                        </a>
                    </div>

                        <div class="card-body px-0 pb-2">
                            <i class="text-sm text-black" >Berita</i>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td class="align-middle text-center text-sm">
                                                <p class="text-xs text-secondary mb-0">Acara Pelaksanaan Seleksi wirausaha muda 2023
                                                </p>
                                            </td>
                                            <td class="align-middle text-center">
                                                <span class="text-secondary text-xs font-weight-bold">Wirausaha</span>
                                            </td>
                                            <td class="align-middle text-center">
                                        ...
                                        <tr>
                                            ...
                                            <td class="align-middle text-center text-sm">
                                                <p class="text-xs text-secondary mb-0">Acara Bazar Wirausahaa muda 2023
                                                </p>
                                            </td>
                                            <td class="align-middle text-center">
                                                <span class="text-secondary text-xs font-weight-bold">Wirausaha</span>
                                        ...
                                        <tr>
                                            ...
                                            <td class="align-middle text-center text-sm">
                                                <p class="text-xs text-secondary mb-0">Webminar Organisasi kepemudaan
                                                </p>
                                            </td>
                                            <td class="align-middle text-center">
                                                <span class="text-secondary text-xs font-weight-bold">Kepemudaan</span>
                                            </td>
                                            <td class="align-middle text-center">
                                                <span class="text-secondary text-xs font-weight-bold">09/10/2023</span>
                                            </td>
