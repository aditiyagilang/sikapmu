<x-layout bodyClass="g-sidenav-show  bg-gray-200">
    ...
    <x-navbars.sidebar activePage="DataPemudaP"></x-navbars.sidebar>
    <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
        <!-- Navbar -->
        <x-navbars.navs.auth titlePage="Data Pemuda Pelapor"></x-navbars.navs.auth>
        <!-- End Navbar -->
                ...
                <div class="col-12">
                    ...
                    <div class="me-3 my-3 text-start">
                        ...
                        <div class="card-body px-0 pb-2">
                            <i class="text-sm text-black" >Data Pemuda Pelapor</i>
